...
public class uckolay : MonoBehaviour
{
    ...
    void Start()
    {
        _1=Random.Range(0,8); _2 = Random.Range(0, 8); while (_1 == _2) { _2= Random.Range(0, 8);}_3 = Random.Range(0, 8); while (_1 == _3||_3==_2) { _3 = Random.Range(0, 8); }
        _4 = Random.Range(0, 8); _5 = Random.Range(0, 8); while (_4 == _5) { _5 = Random.Range(0, 8); }_6 = Random.Range(0, 8); while (_5 == _6 || _4 == _6) { _6 = Random.Range(0, 8); }
        _7 = Random.Range(0, 8); _8 = Random.Range(0, 8); while (_7 == _8) { _8 = Random.Range(0, 8); }_9 = Random.Range(0, 8); while (_8 == _9 || _7 == _9) { _9 = Random.Range(0, 8); }
        _10 = Random.Range(0, 8); _11 = Random.Range(0, 8); while (_10 == _11) { _11 = Random.Range(0, 8); }_12 = Random.Range(0, 8); while (11 == _12 || _10 == _12) { _12 = Random.Range(0, 8); }
    ...
    void Update()
    {
        ...
        if (zaman > 0 && zaman < 5)
        {
            ...
            I1.sprite = dogrular[_1]; I2.sprite = dogrular[_2]; I3.sprite = dogrular[_3];
        }
        else if(zaman > 5 && zaman < 10)
        {
            I1.sprite = dogrular[_1]; I2.sprite = dogrular[_2]; I3.sprite = yanlislar[0];
        }
        else if (zaman > 10 && zaman < 15)
        {
            I1.sprite = dogrular[_4]; I2.sprite = dogrular[_5] ; I3.sprite = dogrular[_6];
        }
        else if (zaman > 15 && zaman < 20)
        {
            I1.sprite = dogrular[_4]; I2.sprite = yanlislar[1]; ; I3.sprite = dogrular[_6];
        }
        else if (zaman > 20 && zaman < 25)
        {
            I1.sprite = dogrular[_7]; I2.sprite = dogrular[_8]; I3.sprite = dogrular[_9];

        }
        else if (zaman > 25 && zaman < 30)
        {
            I1.sprite = yanlislar[2]; I2.sprite = dogrular[_8]; I3.sprite = dogrular[_9];

        }
        else if (zaman > 30 && zaman < 35)
        {
            I1.sprite = dogrular[_10]; I2.sprite = dogrular[_11]; I3.sprite =dogrular[12];
        }
        else if (zaman > 35 && zaman < 40)
        {
            I1.sprite = dogrular[_10]; I2.sprite = dogrular[_11]; I3.sprite = yanlislar[3];
        }
