...
public class ikikolay : MonoBehaviour
{

    public AudioSource[] audios;
    public Text SoruText,TimeText,SkorText;
    ...
    void Update()
    {
        ...
        if (r == 0)
        {
            if(zaman> 0&& zaman <5 )
            {
                ...
                I1.sprite = aa; I2.sprite = bb; I3.sprite = cc;
            }
            else if (zaman > 10 && zaman < 15)
            {
                I1.sprite = bb; I2.sprite = cc; I3.sprite = aa;
            }
            else if (zaman > 20 && zaman < 25)
            {
                I1.sprite = cc; I2.sprite = bb; I3.sprite = aa;
                
            }
            else if (zaman > 30 && zaman < 35)
            {
                I1.sprite = bb; I2.sprite = aa; I3.sprite = cc;
            }
            else
            {
                I1.sprite = dd; I2.sprite = dd; I3.sprite = dd;
            }
        ...
        else if (r == 1)
        {
            ...
            {
                I1.sprite = cc; I2.sprite = aa; I3.sprite = bb;
            }
            else if (zaman > 20 && zaman < 25)
            {
                I1.sprite = aa; I2.sprite = cc; I3.sprite = bb;
